...
/// <summary>
/// Gera UUIDs v5 determinísticos a partir de chaves de negócio — o mesmo algoritmo
/// usado pelos producers e pela versão MassTransit, garantindo correlação entre os dois orquestradores.
/// </summary>
public static class DeterministicId
{
    ...
    public static Guid FromBusinessKey(string businessKey)
    {
