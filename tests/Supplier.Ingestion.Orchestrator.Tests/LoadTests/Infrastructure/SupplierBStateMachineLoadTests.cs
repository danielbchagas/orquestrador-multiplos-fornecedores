...
public class SupplierBStateMachineLoadTests : IAsyncLifetime
{
    ...
    public SupplierBStateMachineLoadTests(ITestOutputHelper output)
    {
        _output = output;
    }
    ...
    public async Task InitializeAsync()
    {
        ...
        try
        {
            ...
            {
                new TopicSpecification { Name = "source.fornecedor-b.v1", NumPartitions = 4, ReplicationFactor = 1 }, // Mais partições para performance
    ...
    public async Task Deve_Suportar_Alta_Carga_De_Processamento()
    {
        ...
        var inputMessages = _fixture.Build<SupplierBInputReceived>()
